...
# ----------------------
BASE_DIR = "data"
POIS_DIR = os.path.join(BASE_DIR, "DBs")
...
def get_point_along_link(row):
    ...
    try:
        ...
        # Handle invalid offset calculations
        return point
...
gdf_pois = gpd.GeoDataFrame(merged, geometry="geometry")
gdf_pois.set_crs("EPSG:4326", inplace=True)
